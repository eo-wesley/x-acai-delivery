export const schemaStatements: string[] = [
    `CREATE TABLE IF NOT EXISTS restaurants (
        ...
        delivery_included_km REAL DEFAULT 3,
        delivery_fee_per_km_cents INTEGER DEFAULT 150,
        delivery_max_distance_km REAL DEFAULT 8,
        delivery_origin_lat REAL,
        delivery_origin_lng REAL,
    ...
    `CREATE TABLE IF NOT EXISTS orders (
        ...
        delivery_address_verified INTEGER DEFAULT 0,
...
export const schemaAlterations: string[] = [
    ...
    `ALTER TABLE restaurants ADD COLUMN delivery_included_km REAL DEFAULT 3`,
    `ALTER TABLE restaurants ADD COLUMN delivery_fee_per_km_cents INTEGER DEFAULT 150`,
    `ALTER TABLE restaurants ADD COLUMN delivery_max_distance_km REAL DEFAULT 8`,
    `ALTER TABLE restaurants ADD COLUMN delivery_origin_lat REAL`,
    `ALTER TABLE restaurants ADD COLUMN delivery_origin_lng REAL`,
    ...
    `ALTER TABLE orders ADD COLUMN delivery_cep TEXT`,
    ...
    `ALTER TABLE orders ADD COLUMN delivery_address_verified INTEGER DEFAULT 0`,
